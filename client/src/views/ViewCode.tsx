import {
  ...
  import { CodeService, Code,Track,TrackService } from "@genezio-sdk/qr-generator";
  ...
  export default function ViewCode() {
    ...
    async function handleEdit(e: React.MouseEvent<HTMLButtonElement>) {
        ...
        const res = await CodeService.updateCode(code!.codeId, codeTitle, codeText).catch(
          (error) => {
            setErrorModal(
              `${
                error.message
        ...
        <Modal isOpen={modalEditCode} toggle={toggleModalEditCode}>
          ...
          <form>
            ...
            <ModalFooter>
              ...
              <Button color="primary" onClick={(e) => handleEdit(e)} type="submit">
                {editCodeLoading ? (
                  <ClockLoader
                    color={"black"}
                            ...
                            {trackingLoading ? (
                              ...
                              <Row>
                                <Col sm="12">
                                  <div className="mb-3">
                                    <p className="mb-0 d-flex flex-column">
                                      <span className="h4">Tracking data</span>
                                    </p>
                                    <div className="mb-3">
