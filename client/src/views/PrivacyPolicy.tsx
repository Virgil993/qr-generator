...
<h3>Google Data</h3>
<p>Our website uses Google OAuth to simplify and secure the login process for our users. When you choose to log in using Google OAuth, we only request access to non-sensitive data, specifically your primary Google Account email address and the information that associates you with your personal info on Google. This information is used solely for authentication purposes, allowing us to verify your identity and provide a personalized user experience. We do not collect, store, or share any additional personal data from your Google account beyond these scopes. Your privacy is of utmost importance to us, and we ensure that any data accessed through Google OAuth is handled with the highest standards of security and confidentiality.</p>
...
<p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the Free Privacy Policy website article.
</p>
...
<li>We may share Your personal information in the following situations:
</li>
